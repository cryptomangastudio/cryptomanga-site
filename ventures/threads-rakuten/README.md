...
> **⚡ v3.1 現実整合**：本事業は**すでに走っている**。創業者は Threads **@tsukuru.laboratory**（つくる｜"めんどくさい"を消す人・フォロワー529・直近閲覧6.9万）で、楽天アフィリ×Threadsツール **らくスレ**（＝リポの `/rakusure/`。旧 `rakuaffi` は**一本化してクローズ**）を無料公開し、**LINE**でリスト化するファネルを運用中。
...
- **`../../rakusure/` — らくスレ**（楽天アフィリ×Threads 投稿ジェネレーター）。**本事業の集客ツール＝コア**。三段構成・500字・楽天短縮URL・#PR自動・保存・ネタ出し。
- `../../rakuaffi/` — 旧「らくアフィ」。**らくスレに一本化してクローズ**（`/rakusure/` へ誘導ページ）。
